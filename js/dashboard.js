...
const CURRICULUM = [
  { week:1, title:'Week 1 — Alphabet Foundations', days:[
    ...
    { day:3, name:'Hebrew II',   sub:'Letters 6–10: Vav to Yod',        lang:'Hebrew', icon:'HEB', hasLesson:false },
    { day:4, name:'Greek II',    sub:'Letters 6–10: Zeta to Kappa',     lang:'Greek',  icon:'GRK', hasLesson:false },
    { day:5, name:'Hebrew III',  sub:'Letters 11–15: Kaf to Samekh',    lang:'Hebrew', icon:'HEB', hasLesson:false },
  ]},
  { week:2, title:'Week 2 — Completing the Alphabet', days:[
    { day:1, name:'Hebrew IV',   sub:'Letters 16–22 + Final Forms',     lang:'Hebrew', icon:'HEB', hasLesson:false },
    { day:2, name:'Greek III',   sub:'Letters 11–17: Lambda to Rho',    lang:'Greek',  icon:'GRK', hasLesson:false },
    { day:3, name:'Hebrew V',    sub:'Vowel Points (Niqqud)',            lang:'Hebrew', icon:'HEB', hasLesson:false },
    { day:4, name:'Greek IV',    sub:'Letters 18–24 (Complete)',         lang:'Greek',  icon:'GRK', hasLesson:false },
    { day:5, name:'Hebrew VI',   sub:'Reading First Words',              lang:'Hebrew', icon:'HEB', hasLesson:false },
  ]},
